//Exercicio 
//Parte 1)
//Escreva um algoritmo que solicite a idade de n alunos ao usuário e ao final apresente O maior, o Menor dos valores informados, a soma e a média aritmética FEITO
//Parte 2) 
...
//solicitar os 3 notas do aluno
// Imprimir relatorio de alunos aprovados e reprovados(meida = 6);
// Aluna 1: Maria - idade: 16  media: 6.7
// Aluna 2: Ana - idade: 17
// Aluno 3: Lucas - idade: 17
// Aluno 4: Carlos - idade: 15
#include <stdio.h>
#include <iostream>
#include <string>
...
int idade, vlrMaior, vlrMenor, vlrMaiorM, vlrMenorM, vlrMaiorH, vlrMenorH, h, m, alunos[100], qtdAlunos, sair;
...
do {
	...
	do {
	  printf(" Informe o sexo do %s: ", Alunos[qtdAlunos].nome);
		scanf("%s", &Alunos[qtdAlunos].sexo);
	} while (Alunos[qtdAlunos].sexo != 'M' & Alunos[qtdAlunos].sexo != 'm' & Alunos[qtdAlunos].sexo != 'F' & Alunos[qtdAlunos].sexo != 'f');
	...
	printf("\n Deseja informar a proxima idade (1/Sim 2/Nao)?");
	scanf("%i", &resposta);
} while (resposta == 1);
